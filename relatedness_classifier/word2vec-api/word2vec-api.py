...
if __name__ == '__main__':
    ...
    p.add_argument("--model_en", help="Path to pre trained english model")
    p.add_argument("--model_id", help="Path to pre trained indonesian model")
    p.add_argument("--binary", help="Specifies the loaded model is binary")
    p.add_argument("--binary_en", help="Specifies the loaded english model is binary")
    p.add_argument("--binary_id", help="Specifies the loaded indonesian model is binary")
    ...
    model_en_path = args.model_en if args.model_en else "./model_en.bin.gz"
    ...
    binary_id = True if args.binary_id else False
    ...
    api.add_resource(Index2Word, '/word2vec/index_2_word')
